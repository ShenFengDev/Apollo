...
//        RenderUtils.drawRect(itemX, sr.getScaledHeight() - 23, itemX + 22, sr.getScaledHeight() - 22, new Color(0, 165, 255));
    ...
    public static void None2(EnumHandSide p_187459_1_, float equippedProg, float swingProgress) {
        int side = p_187459_1_ == EnumHandSide.RIGHT ? 1 : -1;
        GlStateManager.translate(0.56F, -0.52F, -0.71999997F);
        GlStateManager.translate(0.0F, equippedProg * -0.6F, 0.0F);
        GlStateManager.rotate(-102.25F, 1, 0, 0);
    ...
    public static void transformFirstPersonItem(EnumHandSide p_187459_1_, float equippedProg, float swingProgress) {
        int side = p_187459_1_ == EnumHandSide.RIGHT ? 1 : -1;
        GlStateManager.translate(0.56F, -0.52F, -0.71999997F);
        ...
        GlStateManager.rotate((float)f * -20f, 0f, 1f, 0f);
        GlStateManager.rotate((float)f1 * -20f, 0f, 0f, 1f);
        GlStateManager.rotate((float)f1 * -80f, 1f, 0f, 0f);
        //GlStateManager.scale(0.4f, 0.4f, 0.4f);
        GlStateManager.scale(OldHitting.Scale.get(), OldHitting.Scale.get(), OldHitting.Scale.get());
    }
