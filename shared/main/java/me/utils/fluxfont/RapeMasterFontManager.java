...
public  class RapeMasterFontManager {
    ...
    static {
        Font font;
        font = getFont();
        F11 = new RapeMasterFontManager(font.deriveFont(11F));
        F12 = new RapeMasterFontManager(font.deriveFont(12F));
        F13 = new RapeMasterFontManager(font.deriveFont(13F));
        F14 = new RapeMasterFontManager(font.deriveFont(14F));
        F15 = new RapeMasterFontManager(font.deriveFont(15F));
        F16 = new RapeMasterFontManager(font.deriveFont(16F));
        F18 = new RapeMasterFontManager(font.deriveFont(18F));
        F22 = new RapeMasterFontManager(font.deriveFont(22F));
        F24 = new RapeMasterFontManager(font.deriveFont(24F));
        F35 = new RapeMasterFontManager(font.deriveFont(35F));
        F40 = new RapeMasterFontManager(font.deriveFont(40F));
        for (int i = 0; i < 32; ++i) {
            int base = (i >> 3 & 1) * 85;
    ...
    public final static Font getFont() {
        Font font;
        try {
            InputStream is = Minecraft.getMinecraft().getResourceManager().getResource(new ResourceLocation("liquidbounce/font/wqy_microhei.ttf")).getInputStream();
