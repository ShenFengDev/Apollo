...
public final class RenderUtils extends MinecraftInstance {
    ...
    public static void drawShadow2(int x, int y, float width, float height) {
        drawImage(classProvider.createResourceLocation("liquidbounce/shadow/shadow_250_125.png"), x - 25, y - 25, (int) (width + 50), (int) (height + 50));
    }
    ...
    public static void drawOutlineBlockBox(final WBlockPos blockPos, final Color color, final boolean outline) {
