...
public final class RotationUtils extends MinecraftInstance implements Listenable {
    ...
    public static VecRotation lockView2(final IAxisAlignedBB bb, final boolean outborder, final boolean random,
        ...
        final WVec3 eyes = Objects.requireNonNull(mc.getThePlayer()).getPositionEyes(1F);
        ...
        if (aura.getTarget() == null) {
            ...
            xMin = 0.15D ;xMax = 0.85D ;xDist= 0.12D;
            yMin =0.15D ;yMax = 1D ;yDist = 0.12D;
            zMin = 0.15D; zMax = 0.85D ;zDist = 0.12D;



        }
        if (aura.getTarget() != null&&aura.getTarget().getPosY() > mc.getThePlayer().getPosY()) {

            xMin = 0.20D; xMax = 0.3D; xDist = 0D;
            yMin = 0.05D; yMax = 0.15D; yDist = 0D;
            zMin = 0.20D; zMax = 0.3D; zDist = 0D;
        ...
        if (aura.getTarget() != null&&aura.getTarget().getPosY() < mc.getThePlayer().getPosY()){
            ...
            xMin = 0.45D; xMax = 0.55D; xDist = 0.0122D;
            yMin = 0.05D; yMax = 0.15D; yDist = 0.0122D;
            zMin = 0.45D; zMax = 0.55D; zDist = 0.0122D;
