...
//        GL11.glEnable(GL11.GL_SCISSOR_TEST)
        ...
        val image = MinecraftInstance.classProvider.createResourceLocation("liquidbounce/notification/" + type.name.toLowerCase() + ".png")
       ...
       // RenderUtils.drawShadow(-22, 0, width + 22, height)
        ...
        RoundedUtil.drawRound(-22f,0f,width.toFloat()+10f,height.toFloat(),4f,Color(255, 255, 255, 225))
        ...
        Fonts.font35.drawString(title, 7F, 4F, Color(0, 0, 0, 225).rgb)
        Fonts.font30.drawString(content, 7F, 17F, Color(0, 0, 0, 225).rgb)
