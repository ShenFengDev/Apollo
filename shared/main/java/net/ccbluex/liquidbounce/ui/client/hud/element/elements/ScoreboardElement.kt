...
class ScoreboardElement(
    ...
    override fun drawElement(): Border? {
        ...
        scoreCollection.forEachIndexed { index, score ->
            ...
            FontLoaders.F16.drawString(name, l1.toFloat(), height.toFloat(), listColor, shadowValue.get())
            if (!noPointValue.get()) {
            ...
            if (index == scoreCollection.size - 1) {
                ...
                FontLoaders.F18.drawString(displayName, (l1 + maxWidth / 2 -  fontRenderer.getStringWidth(displayName) / 2).toFloat(), (height -
