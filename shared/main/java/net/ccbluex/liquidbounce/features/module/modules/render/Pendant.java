...
public class Pendant extends Module {
    ...
    public void Fubuki(){
        ...
        if (Fubukistyle.get().contains("GIF")){
            ...
            RenderUtils.drawImage(classProvider.createResourceLocation("liquidbounce/fubuki/" + state + ".png"),positionX.getValue().intValue() , VisualUtils.height() - positionY.getValue().intValue(), size.getValue().intValue(), size.getValue().intValue());
        }

        if (Fubukistyle.get().contains("Static")){
            RenderUtils.drawImage(classProvider.createResourceLocation("liquidbounce/fubuki/Static.png"),positionX.getValue().intValue() , VisualUtils.height() - positionY.getValue().intValue(), 77 ,250);
        }
    }
    ...
    public void Taco(){
        ...
        RenderUtils.drawImage(classProvider.createResourceLocation("liquidbounce/taco/" + state + ".png"), (int) posX, VisualUtils.height() - 80, 42, 27);
    }
