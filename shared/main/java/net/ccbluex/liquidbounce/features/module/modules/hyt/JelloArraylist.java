...
public class JelloArraylist extends Module {
    ...
    public void renderArraylist() { 
        ...
        for (Module module : modules) {
            ...
            xStart = (float) (sr.getScaledWidth() - FontLoaders.F16.getStringWidth(module.getName()) - 5);

            GlStateManager.pushMatrix();
            GlStateManager.disableAlpha();
            RenderUtils.drawImage3(wtf, xStart - 8 - 2 - 1, yStart + 2 - 2.5f - 1.5f - 1.5f - 1.5f - 6 - 1, (int)(FontLoaders.F16.getStringWidth(module.getName()) + 20 + 10), (int)(18.5 + 6 + 12 + 2), 1f, 1f, 1f, (module.getAnimation() / 20F) * 0.7f);
        ...
        for (Module module : modules) {
            ...
            FontLoaders.F16.drawString(module.getName(), xStart, yStart + 7.5f, new Color(1F, 1F, 1F, (module.getAnimation() / 20F) * 0.7f).getRGB());
            if (useTrueFont.get()) {
                GlStateManager.enableAlpha();
            }
            GlStateManager.popMatrix();
    ...
    class ModComparator implements Comparator<Module> {
        ...
        public int compare(Module e1, Module e2) {
            return (FontLoaders.F16.getStringWidth(e1.getName()) < FontLoaders.F16.getStringWidth(e2.getName()) ? 1 : -1);
        }
    }
}