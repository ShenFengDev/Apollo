...
@ModuleInfo("SpeedMine", description = "A module of reduce you digging time", category = ModuleCategory.WORLD)
class SpeedMine : Module() {
    private val modeValue = ListValue("Mode", arrayOf("Grim", "Packet", "NewPacket", "NewPacket2", "MoonX", "Tenacity"),"NewPacket")
