...
class Criticals : Module() {
    ...
    val modeValue = ListValue("Mode", arrayOf("Grim","GrimACTest-1","GrimACTest-2","HuaYuTing","sb","NewPacket","HytSpartan","AAC4Hyt", "Lite", "HytTest", "HytVulcan",  "Vulcan", "vulcanfake", "Spartan", "StarPacket", "Packet", "NcpPacket", "NoGround", "Hop", "TPHop", "Jump", "LowJump", "Visual"), "Packet")
