...
@ModuleInfo(name = "AutoLobby", description = "Bypass", category = ModuleCategory.HYT)
class AutoLobby : Module(){
    ...
    var hubchattext = TextValue("HubChat","[D1ckBounce]EnjoyTheLife")
    ...
    fun onUpdate(event: UpdateEvent){
        ...
        val grimVelocity = LiquidBounce.moduleManager[GrimVelocity::class.java] as GrimVelocity
